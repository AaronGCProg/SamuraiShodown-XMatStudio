...
ModulePlayer2::ModulePlayer2()
{
	...
	jumpKick.PushBack({ 1102,21,71,80 }, 6, { 31,2 }, jumpKickCollider2, jumpKickHitbox2, jumpKickCollType2, jumpKickCallBack2, 11, 7, 7, 1);
	jumpKick.PushBack({ 1160,146,122,96 }, 32, { 31,2 }, jumpKickCollider, jumpKickHitbox, jumpKickCollType, jumpKickCallBack, 11, 7, 7, 1);
	jumpKick.PushBack({ 1102,21,71,80 }, 6, { 31,2 }, jumpKickCollider2, jumpKickHitbox2, jumpKickCollType2, jumpKickCallBack2, 11, 7, 7, 1);
	...
	// Kick animation 
	strongkick.PushBack({ 801,2157,67,93 }, 9, { 31,2 }, strongkickCollider2, strongkickHitbox2, strongkickCollType2, strongkickCallBack2, 18, 10, 10, 2);
	strongkick.PushBack({ 902,2141,90,109 }, 9, { 31,2 }, strongkickCollider2, strongkickHitbox2, strongkickCollType2, strongkickCallBack2, 18, 10, 10, 2);
	strongkick.PushBack({ 1022,2132,81,118 }, 9, { 31,2 }, strongkickCollider, strongkickHitbox, strongkickCollType, strongkickCallBack, 18, 10, 10, 2);
	strongkick.PushBack({ 1198,839,117,93 }, 9, { 31,2 }, strongkickCollider, strongkickHitbox, strongkickCollType, strongkickCallBack, 18, 10, 10, 2);
	...
	jumpmidPunch.PushBack({ 1,819,83,87 }, 12, { 31, 2 }, jumpmidPunchCollider2, jumpmidPunchHitbox2, jumpmidPunchCollType2, jumpmidPunchCallBack2, 7, 7, 20, 3);
	jumpmidPunch.PushBack({ 85,824,79,82 }, 12, { 31, 2 }, jumpmidPunchCollider, jumpmidPunchHitbox, jumpmidPunchCollType, jumpmidPunchCallBack, 13, 7, 7, 3);
	jumpmidPunch.PushBack({ 165,835,73,71 }, 10, { 31, 2 }, jumpmidPunchCollider, jumpmidPunchHitbox, jumpmidPunchCollType, jumpmidPunchCallBack, 13, 7, 7, 3);
	jumpmidPunch.PushBack({ 1,1160,155,70 }, 12, { 31, 2 }, jumpmidPunchCollider2, jumpmidPunchHitbox2, jumpmidPunchCollType2, jumpmidPunchCallBack2, 13, 7, 7, 3);
	jumpmidPunch.PushBack({ 396,837,157,69 }, 12, { 31, 2 }, jumpmidPunchCollider, jumpmidPunchHitbox, jumpmidPunchCollType, jumpmidPunchCallBack, 13, 7, 7, 3);
	jumpmidPunch.PushBack({ 554,842,147,64 }, 12, { 31, 2 }, jumpmidPunchCollider, jumpmidPunchHitbox, jumpmidPunchCollType, jumpmidPunchCallBack, 13, 7, 7, 3);
	...
	crouchstrongKick.PushBack({ 1102,21,71,80 }, 4, { 31,2 }, crouchstrongPunchCollider, crouchstrongKickHitbox, crouchstrongKickCollType, crouchstrongKickCallBack, 25, 10, 10, 2);
	crouchstrongKick.PushBack({ 1262,31,122,86 }, 8, { 31,2 }, crouchstrongKickCollider, crouchstrongKickHitbox, crouchstrongPunchCollType, crouchstrongKickCallBack, 25, 10, 10, 2);
	crouchstrongKick.PushBack({ 1056,267,76,102 }, 4, { 31,2 }, crouchstrongPunchCollider, crouchstrongKickHitbox, crouchstrongKickCollType, crouchstrongKickCallBack, 25, 10, 10, 2);
	crouchstrongKick.PushBack({ 1277,272,97,97 }, 8, { 31,2 }, crouchstrongKickCollider, crouchstrongKickHitbox, crouchstrongPunchCollType, crouchstrongKickCallBack, 25, 10, 10, 2);
	crouchstrongKick.PushBack({ 1056,267,76,102 }, 4, { 31,2 }, crouchstrongPunchCollider, crouchstrongKickHitbox, crouchstrongKickCollType, crouchstrongKickCallBack, 25, 10, 10, 2);
	// falta poner si alugna se repite y eso
	...
	// Punch animation 
	NWpunch.PushBack({ 117,2862,73,97 }, 7, { 31,2 }, NWpunchCollider, NWpunchHitbox, NWpunchCollType, NWpunchCallBack, 8, 4, 4, 3);
	NWpunch.PushBack({ 226,2870,82,89 }, 7, { 31,2 }, NWpunchCollider, NWpunchHitbox, NWpunchCollType, NWpunchCallBack, 8, 4, 4, 3);
	NWpunch.PushBack({ 350,2870,91,89 }, 5, { 31,2 }, NWpunchCollider, NWpunchHitbox, NWpunchCollType, NWpunchCallBack, 8, 4, 4, 3);
	NWpunch.PushBack({ 477,2870,91,89 }, 6, { 31,2 }, NWpunchCollider, NWpunchHitbox, NWpunchCollType, NWpunchCallBack, 8, 4, 4, 3);
	...
	// Punch animation 
	NWstrongpunch.PushBack({ 2114,2854,72,100 }, 7, { 31,2 }, NWstrongpunchCollider, NWstrongpunchHitbox, NWstrongtrongpunchCollType, NWstrongtrongpunchCallBack, 14, 8, 8, 3);
	NWstrongpunch.PushBack({ 645,2867,92,92 }, 7, { 31,2 }, NWstrongpunchCollider, NWstrongpunchHitbox, NWstrongtrongpunchCollType, NWstrongtrongpunchCallBack, 14, 8, 8, 3);
	NWstrongpunch.PushBack({ 782,2862,66,96 }, 5, { 31,2 }, NWstrongpunchCollider, NWstrongpunchHitbox, NWstrongtrongpunchCollType, NWstrongtrongpunchCallBack, 14, 8, 8, 3);
	NWstrongpunch.PushBack({ 884,2870 ,89,89 }, 6, { 31,2 }, NWstrongpunchCollider, NWstrongpunchHitbox, NWstrongtrongpunchCollType, NWstrongtrongpunchCallBack, 14, 8, 8, 3);
	NWstrongpunch.PushBack({ 645,2867,92,92 }, 6, { 31,2 }, NWstrongpunchCollider, NWstrongpunchHitbox, NWstrongtrongpunchCollType, NWstrongtrongpunchCallBack, 14, 8, 8, 3);
	NWstrongpunch.PushBack({ 2114,2854,72,100 }, 6, { 31,2 }, NWstrongpunchCollider, NWstrongpunchHitbox, NWstrongtrongpunchCollType, NWstrongtrongpunchCallBack, 14, 8, 8, 3);
...
update_status ModulePlayer2::Update()
{
	...
	if (sprinting) {
		...
		if (current_state != ST_SPRINT_END2 && current_state != ST_SPRINT2) {
		...
		if ((App->player->close && !App->player->invencibleframes && App->player->position.y == position.y) || current_state == ST_GRABBING2) {
			...
			if (App->player->current_state == ST_GET_GRABBED2 || grabStates >= 0) {
				...
				if (grabStates < 3) {
					...
					if (swordDrop || swordOnTheGround)
						App->player->current_animation = &App->player->NWfall; // FALTA ANIM + FALTA ANIM FALLING
					else
						App->player->current_animation = &App->player->getGrab;
				}
				...
				if (grab.GetAnimEnd() == true) {
					...
					App->slowdown->StartSlowdown(15, 1);
					App->render->StartCameraShake(15, 2);
					App->slowdown->StartSlowdown(15, 1);
					App->render->StartCameraShake(15, 2);
					App->slowdown->StartSlowdown((int)40, 4);
	...
	if (grabbing2) {
		if ((App->player->close && !App->player->invencibleframes && App->player->position.y == position.y) || current_state == ST_SECOND_GRAB2) {
			...
			if (App->player->current_state == ST_GET_GRABBED || grabStates >= 0) {
				...
				if (midgrab.GetAnimEnd() == true || grabStates == 5) {
					grabStates = 0;
					grab.SetAnimEnd(false);
	...
	if (crouchkicking)
	{
		...
		//stop crouch punch anim
		if (crouchKick.GetAnimEnd() == true || crouchmidKick.GetAnimEnd() == true || crouchstrongKick.GetAnimEnd() == true || NWcrouchstrongKick.GetAnimEnd() == true)
		{
			...
			NWcrouchstrongKick.SetAnimEnd(false);
		}
	}
	...
	{
		if (swordDrop || swordOnTheGround)
			current_animation = &NWfall; //FALTA ANIM
		else
	...
	if (!godMode2 && !blocking) {
		...
		if (c2->type == COLLIDER_PLAYER_SHOT) {
			if (blocking && (current_state == ST_WALK_BACKWARD || current_state == ST_CROUCH)) {
				...
				App->slowdown->StartSlowdown(15, 1);
				App->render->StartCameraShake(15, 2);
				App->slowdown->StartSlowdown((int)60, 2);
				powValue += 2;
		...
		if (c2->type == COLLIDER_PLAYER_ATTACK && c1->type == COLLIDER_ENEMY && !getsHit) {
			int random = rand();
			...
			if (blocking && (current_state == ST_WALK_BACKWARD2 || current_state == ST_CROUCH2 || current_state == ST_WALK_FORWARD2 || crouching)) {
				...
				if (powActivated || App->player->powActivated) {
					...
					App->slowdown->StartSlowdown(35, 1);
					App->render->StartCameraShake(40, 2);
					App->slowdown->StartSlowdown((int)c2->delayEnemy*4.5, random);
					...
					health += c2->damage;
					App->slowdown->StartSlowdown(25, 1);
					App->render->StartCameraShake(30,2);
	...
	if (App->fight->playerControl) {
		...
		while (SDL_PollEvent(&event2) != 0)
		{
			...
			if (event2.type == SDL_KEYDOWN && event2.key.repeat == 0)
			{
				...
				case SDLK_w:
					up = true;
					App->input->pads[0].up = true;

					break;
				case SDLK_s:
					down = true;
					App->input->pads[0].down = true;

					break;
				case SDLK_a:
					left = true;
					App->input->pads[0].left = true;

					break;
				case SDLK_d:
					right = true;
					App->input->pads[0].right = true;
			...
			if (event2.type == SDL_CONTROLLERBUTTONDOWN)
			{
				...
				case SDL_CONTROLLER_BUTTON_X:
					if (App->input->controller_player1_X_pressed == true) {
						...
						if (App->input->CheckSpecial1(50, 0, App->player->playerFlip) == true && !App->player->swordDropped) {
							inputs.Push(IN_FIRST_SPECIAL);
							attacked = true;
						}
						//if (App->input->CheckSpecial2(50, 0, App->player->playerFlip) == true && !App->player->swordDropped) {
						//	inputs.Push(IN_SECOND_SPECIAL);
						//	attacked = true;
						//}
					...
					if (App->input->controller_player2_X_pressed == true) {
						...
						if (App->input->CheckSpecial1(50, 0, App->player2->playerFlip) == true && !App->player2->swordDropped) {
							p2inputs.Push(IN_FIRST_SPECIAL2);
							attacked = true;
						}
						if (App->input->CheckSwordGrab(30, 1, App->player2->playerFlip) == true && App->player2->closeSword == true) {
							p2inputs.Push(IN_SWORD_GRAB2);
				...
				case SDL_CONTROLLER_BUTTON_Y:
					...
					if (App->input->controller_player2_Y_pressed == true) {
						...
						if (App->input->CheckThrow2(40, 0, App->player2->playerFlip) == true && App->player->close == true) {
							p2inputs.Push(IN_GRAB2);
							attacked = true;
						}
			...
			if (App->input->Controller_player1_Connected) {
				if (App->input->Controller_player1_LAxisX > DEATHZONE) {
					...
					if (!App->player->playerFlip) {
						...
						if (App->input->CheckSprint(10, 0, App->player->playerFlip) == true)
...
player2_states ModulePlayer2::process_fsm(p2Qeue<player2_inputs>& inputs)
{
	...
	while (p2inputs.Pop(last_input))
	{
		...
		case ST_IDLE2:
		{
			...
			case IN_X_MID2:
				if (App->player->close)
					state = ST_PUNCH_CLOSE_STANDING_MID2;
				else
					state = ST_MID_PUNCH_STANDING2;
				blocking = false; break;

			case IN_X_STRONG2:
				if (App->player->close)
					state = ST_PUNCH_CLOSE_STANDING_STRONG2;
				else
					state = ST_STRONG_PUNCH_STANDING2;
				blocking = false; break;
		...
		case ST_WALK_FORWARD2:
		{
			...
			case IN_SIDE_STEP2: state = ST_SIDE_STEPPING2; break;
			case IN_SPRINT2: state = ST_SPRINT2; break;
			case IN_FIRST_SPECIAL2: state = ST_FIRST_SPECIAL2;  break;
		...
		case ST_SPRINT2:
		{
			...
			case IN_X2:
				if (App->player->close)
					...
					state = ST_PUNCH_STANDING2;
				blocking = false; break;
			case IN_KICK2: state = ST_KICK_STANDING2; break;
			case IN_SPECIAL2: state = ST_SPECIAL2; break;
