...
update_status ModulePlayerSelection::Update()
{
	...
	App->render->Blit(ui, 53, 194, false, &japanword, NULL, true);//japanleft
	App->render->Blit(ui, 213, 194, false, &japanword, NULL, true);//japanright

	App->render->Blit(ui, 32, 160, false, &jubeiword, NULL, true);//jubeileft
	App->render->Blit(ui, 192, 160, false, &jubeiword, NULL, true);//jubeiright
